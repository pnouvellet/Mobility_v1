...
# useful functions
sapply(paste0('Rscript/MCMC_over2/',(list.files('Rscript/MCMC_over2/'))),FUN = source)
...
apply(res_projection_ST$D_pred[,1,],1,median)
apply(res_projection_ST$D_pred[,1,],1,mean)
...
res_projection_LT1 <- mobility_prediction_over2(n_pred = n_pred, rep_sim = rep_sim2)

# aa <- res_projection_LT1$D_pred[,1,]
# which(is.na(aa[,163]))
# 
# apply(res_projection_LT1$D_pred[1:7,1,],1,median)
# apply(res_projection_LT1$D_pred[1:7,1,],1,mean)
...
res_projection_LT2 <- mobility_prediction_over2(n_pred = n_pred, rep_sim = rep_sim2)
...
res_projection_LT3 <- mobility_prediction_over2(n_pred = n_pred, rep_sim = rep_sim2)
...
saveRDS(object = output,
        file = paste0('Rdata/',date_week_finishing,'_output_over_SI_',si,'.rds' ))
```
